...
export function NgoRootLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="h-full min-h-0 flex flex-col bg-gradient-to-br from-white via-[#b2d8d0]/35 to-white relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col flex-1 min-h-0">
        <NgoTopNavBar />
        <main className="flex-1 min-h-0 overflow-y-auto max-w-[1600px] w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-24 lg:pb-8">
          {children}
        </main>
        <NgoMobileBottomNav />
