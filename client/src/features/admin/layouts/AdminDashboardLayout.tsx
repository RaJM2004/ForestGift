  ...
  return (
    <div className="h-full min-h-0 flex flex-col bg-gradient-to-br from-white via-zinc-100/40 to-white relative overflow-hidden text-zinc-950 font-sans">
      ...
      <div className="relative z-10 flex flex-col flex-1 min-h-0">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  {onLogout && (
                    <button
                      type="button"
                      onClick={onLogout}
                      className="inline-flex h-10 items-center gap-2 rounded-lg border border-zinc-200 px-3 text-zinc-700 hover:bg-zinc-50 transition-colors shadow-xs"
                    >
        ...
        <main className="flex-1 min-h-0 overflow-y-auto max-w-[1400px] w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-24 lg:py-8 lg:pb-8 relative z-10">
        ...
        <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-zinc-200 z-40 shadow-lg">
