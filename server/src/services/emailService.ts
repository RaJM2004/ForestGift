    ...
    const html = `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 40px; border: 1px solid #e2e8f0; border-radius: 24px; color: #1a202c;">
            ...
            <div style="background-color: #f8fafc; padding: 24px; border-radius: 16px; margin: 32px 0;">
                ...
                <p style="margin: 8px 0;"><strong>Password:</strong> <code style="background: #edf2f7; padding: 2px 6px; border-radius: 4px; font-weight: bold; color: #059669;">${password}</code></p>
                <p style="margin: 8px 0;"><strong>Digital Token:</strong> <code style="background: #edf2f7; padding: 2px 6px; border-radius: 4px; font-weight: bold; color: #059669;">${token}</code></p>
            </div>
