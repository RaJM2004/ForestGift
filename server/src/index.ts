...
app.post('/api/seed', async (req, res) => {
  try {
    const USERS = [
      { id:"USR001", name:"Ramesh Kumar", dob:"1985-03-14", address:"12, MG Road, Bhopal MP", phone:"9876543210", email:"ramesh@email.com", token:"TKN-2024-0001", amount:5000, trees:5, status:"Planted", ngo:"GreenEarth NGO", location:"Block A, Satpura Zone", date:"2024-01-15", referralCount: 15, globalRank: 42 },
      { id:"USR002", name:"Sunita Devi", dob:"1990-07-22", address:"45, Civil Lines, Jabalpur MP", phone:"9812345678", email:"sunita@email.com", token:"TKN-2024-0002", amount:3000, trees:3, status:"Pending", ngo:"VanaRaksha Foundation", location:"Block B, Vindhya Zone", date:"2024-01-18", referralCount: 8, globalRank: 156 },
      { id:"USR003", name:"Arun Mehta", dob:"1978-11-05", address:"78, Nai Basti, Indore MP", phone:"9988776655", email:"arun@email.com", token:"TKN-2024-0003", amount:10000, trees:10, status:"Planted", ngo:"GreenEarth NGO", location:"Block C, Satpura Zone", date:"2024-01-20", referralCount: 22, globalRank: 12 },
      { id:"USR004", name:"Priya Sharma", dob:"1995-02-28", address:"33, Shivaji Nagar, Bhopal MP", phone:"9765432100", email:"priya@email.com", token:"TKN-2024-0004", amount:2000, trees:2, status:"Pending", ngo:"Not Assigned", location:"TBD", date:"2024-01-22", referralCount: 3, globalRank: 890 },
      { id:"USR005", name:"Vijay Patel", dob:"1982-09-17", address:"101, Gandhi Chowk, Rewa MP", phone:"9654321098", email:"vijay@email.com", token:"TKN-2024-0005", amount:7000, trees:7, status:"Planted", ngo:"SahyogVan Trust", location:"Block D, Amarkantak Zone", date:"2024-01-25", referralCount: 11, globalRank: 245 },
      { id:"USR006", name:"Meera Joshi", dob:"1988-06-11", address:"55, Lal Bagh, Ujjain MP", phone:"9543210987", email:"meera@email.com", token:"TKN-2024-0006", amount:4000, trees:4, status:"Pending", ngo:"VanaRaksha Foundation", location:"Block A, Malwa Zone", date:"2024-01-28", referralCount: 6, globalRank: 432 },
    ];
